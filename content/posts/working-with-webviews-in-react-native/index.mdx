...
For those instances when it's impractical or impossible to re-architect an existing web page in React Native, the framework allows us to simply embed them in our apps with the WebView component. Let's look at some of the functionality exposed through the WebView API.
